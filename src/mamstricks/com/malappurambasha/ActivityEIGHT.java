...
public class ActivityEIGHT extends Activity {
	...
	public void playsound(View v) {
		if(v.getId()==R.id.button1){
			...
			ourSong=MediaPlayer.create(ActivityEIGHT.this, R.raw.ijju);
		...
		if(v.getId()==R.id.button2){
			...
			ourSong=MediaPlayer.create(ActivityEIGHT.this, R.raw.manam);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
		...
		if(v.getId()==R.id.button3){
			ourSong=MediaPlayer.create(ActivityEIGHT.this, R.raw.manda);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
		...
		if(v.getId()==R.id.button4){
			ourSong=MediaPlayer.create(ActivityEIGHT.this, R.raw.pummalu);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
		...
		if(v.getId()==R.id.button5){
			ourSong=MediaPlayer.create(ActivityEIGHT.this, R.raw.eesalavuka);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
