...
public class ActivitySIX extends Activity {
	...
	public void playsound(View v) {
		if(v.getId()==R.id.button1){
			...
			ourSong=MediaPlayer.create(ActivitySIX.this, R.raw.kunuttu);
		...
		if(v.getId()==R.id.button2){
			...
			ourSong=MediaPlayer.create(ActivitySIX.this, R.raw.njakudi);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
		...
		if(v.getId()==R.id.button3){
			ourSong=MediaPlayer.create(ActivitySIX.this, R.raw.kujju);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
		...
		if(v.getId()==R.id.button4){
			ourSong=MediaPlayer.create(ActivitySIX.this, R.raw.pennungal);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
		...
		if(v.getId()==R.id.button5){
			ourSong=MediaPlayer.create(ActivitySIX.this, R.raw.pijju);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
