...
public class ActivityTWO extends Activity {
	...
	public void playsound(View v) {
		if(v.getId()==R.id.button1){
			...
			ourSong=MediaPlayer.create(ActivityTWO.this, R.raw.arukku);
		...
		if(v.getId()==R.id.button2){
			...
			ourSong=MediaPlayer.create(ActivityTWO.this, R.raw.anjan);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
		...
		if(v.getId()==R.id.button3){
			ourSong=MediaPlayer.create(ActivityTWO.this, R.raw.badakkani);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
		...
		if(v.getId()==R.id.button4){
			ourSong=MediaPlayer.create(ActivityTWO.this, R.raw.oolu);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
		...
		if(v.getId()==R.id.button5){
			ourSong=MediaPlayer.create(ActivityTWO.this, R.raw.ichu);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
