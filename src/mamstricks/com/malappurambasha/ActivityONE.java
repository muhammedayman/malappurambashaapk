...
public class ActivityONE extends Activity {
	...
	public void playsound(View v) {
		if(v.getId()==R.id.button1){
			...
			//ourSong.reset();
			ourSong=MediaPlayer.create(ActivityONE.this, R.raw.payayathu);			
		...
		if(v.getId()==R.id.button2){
			...
			ourSong=MediaPlayer.create(ActivityONE.this, R.raw.payam);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
		...
		if(v.getId()==R.id.button3){
			ourSong=MediaPlayer.create(ActivityONE.this, R.raw.vaya);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
		...
		if(v.getId()==R.id.button4){
			ourSong=MediaPlayer.create(ActivityONE.this, R.raw.kayikkuka);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
		...
		if(v.getId()==R.id.button5){
			ourSong=MediaPlayer.create(ActivityONE.this, R.raw.chamakkkuka);
			ourSong.setOnCompletionListener(new OnCompletionListener() {
			    public void onCompletion(MediaPlayer ourSong) {
			    	ourSong.release();
